...
\chapter{Dynamic parallelism detection}
	...
	\section{Terminology}
		...
		\begin{itemize}
			...
			\item Loop instance
		\end{itemize}
	\section{Parallel and non-parallel algorithms}
...
for(int i = 1; i < n; i++){
	...
	\section{Dependency graphs}
		...
		The formal notion is simple. Two procedures can run in parallel if neither uses input from the other.
	...
	\section{Pairwise method}
		...
		In order to do this formally, we will need 
		 history-tables, pending tables, and killed bits. 
